...
public class PetStorePersistentManager extends PersistentManager {
    private static final String PROJECT_NAME = "PetStore";
    ...
    private PetStorePersistentManager() throws PersistentException {
