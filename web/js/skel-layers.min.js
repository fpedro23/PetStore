...
skel.registerPlugin("layers", function (e) {
    function cn(e, r, i) {
        var o, u;
        this.id = e, this.index = i, this[n] = {breakpoints: x, states: x, position: x, side: x, animation: mt, orientation: mt, width: 0, height: 0, zIndex: this.index, html: "", hidden: H, exclusive: V, resetScroll: V, resetForms: V, swipeToHide: V, clickToHide: H}, t._.extend(this[n], r), this[j] = t._.newDiv(this[n][jt]), this[j].id = e, this[j]._layer = this, this[s] = x, this[bt] = x, this[St] = x, this[z] = H, u = t._.newElement(this.id, this[j], ut, 1), u.onAttach = function () {
            var e = this[$t]._layer;
            e[Z]() || e.init(), e.resume()
        }, u.onDetach = function () {
            var e = this[$t]._layer;
    ...
    }, cn[C][ft] = {none: {show: function (e) {
        var t = e[n], r = e[s];
        r[B](0)[c](t.zIndex)[rn](), t[$] && r[f](), e[d]()
    }, hide: function (e) {
        var t = e[n], r = e[s];
        r[It]()[p](), e[m]()
    }}, overlayX: {show: function (e) {
        var r = e[n], i = e[s];
    ...
    }}}, cn[C][xt] = {"top-left": {v: q, h: k, side: k}, "top-right": {v: q, h: g, side: g}, top: {v: q, h: T, side: q}, "top-center": {v: q, h: T, side: q}, "bottom-left": {v: y, h: k, side: k}, "bottom-right": {v: y, h: g, side: g}, bottom: {v: y, h: T, side: y}, "bottom-center": {v: y, h: T, side: y}, left: {v: T, h: k, side: k}, "center-left": {v: T, h: k, side: k}, right: {v: T, h: g, side: g}, "center-right": {v: T, h: g, side: g}}, cn[C][rn] = function () {
        var e, r, o, a, f;
        if (this[z]) {
            t[i][u][ht](this[j]);
            return
    ...
    }, t = {cache: {visibleWrapper: x, body: x, exclusiveLayer: x, html: x, htmlbody: x, hiddenWrapper: x, layers: {}, window: x, wrapper: x}, config: {baseZIndex: 1e4, layers: {}, speed: 250, transform: V, transformBreakpoints: x, transformTest: x}, eventType: "click touchend", show: function (e) {
        t._[Pt](function () {
            t[i][ct][e][rn]()
        })
    }, hide: function (e) {
