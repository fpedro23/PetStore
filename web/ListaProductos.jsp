                            ...
                            <tr>
                                ...
                                <form action="listItemsFromProduct" name="listItemsFromProduct">
                                    <input type="hidden" name="nombreCategoria"
                                           value="<%out.print(listaProductos[i].getCategorias().getNombreCategoria());%>"/>
                                    <input type="hidden" name="nombreProducto"
                                           value="<%out.print(listaProductos[i].getNombreProducto());%>"/>
                                    <ul class="buttons">
                                        <li><input type="submit"
                                                   value="<%out.println(listaProductos[i].getNombreProducto());%>"/>
                                        </li>
                                    </ul>
                                </form>
                                </p>
